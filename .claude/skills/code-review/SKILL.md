...
4. Style and consistency (Biome formatting + project conventions)
...
- Template generators return valid TypeScript/JSX
- CLI options validated with helpful error messages
- New features documented in README.md
- Skills manifest updated if needed (`assets/skills.json`)
